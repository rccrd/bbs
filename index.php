...
if(!isset($minibb_copyright_txt)) $minibb_copyright_txt=<<<out
{$l_poweredBy} <a href="http://www.minibb.com/" target="_blank" title="{$sitename} {$l_poweredBy} {$software} miniBB &reg;">{$software} miniBB</a>&reg;
out;
