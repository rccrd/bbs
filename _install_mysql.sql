...
create table bb2_unreadtopics (topic_id int(10) not null, post_id int(10) not null, user_id int(10) not null, key check_selection (topic_id, user_id), key user_id (user_id));
create table bb2_unreadpoint (user_id int(10) not null, last_id int(10) not null, key user_id (user_id));