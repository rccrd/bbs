...
Copyright (C) 2001-2015 miniBB.com.
...
Latest File Update: 2015-Sep-22
*/
...
$l_userErrors[6]='You must provide a full URL to the website, starting with http:// or https:// .<br />This field is possible to fill in only if you have posted at least '.$allowHyperlinks.' useful messages on forum.';
...
$l_delSendMais='Type an email address to delete, then click the 1st button; OR click the 2nd button for clearing up the whole table.<br />In the case of deleting certain emails (the 1st button), you may use `*` (an asterisk) before `@` for deleting only certain domain emails;<br />for example: typing `*@minibb.com` will delete all subscriptions associated with `minibb.com` <em>only</em>.<br /><strong>Attention:</strong> click with care, you will be not asked twice!';
$l_delete='Delete';
...
$emailTitleReg='<br />Please, specify a valid working email address. Your forums password will be emailed there.';
$emailTitlePrefs='<br />If you change your email address, a confirmation link will be sent on it. Until you confirm it, you will not be able to enter forums as a member.';
/* Avatars language */
$l_usrInfo[12]='Avatar';

/* Anti-guest addon language */
$anti_guest_title='Anti-spam protection';
$anti_guest_rule1='This rule is applied to all guests, and registered members, who has posted less than {POSTS_REQUIRED} messages.';
...
$l_bb_color='Color Picker';

$l_bb_vimeo='Vimeo Code';

/* Youtube */
$l_bb_youtube='Insert YouTube video';

$l_bb_spoiler='Spoiler!';
